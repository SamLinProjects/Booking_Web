...
export default function Footer(){
    ...
    return(
        ...
        className={`flex max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-14
        min-w-0 px-2 gap-4 pl-5 pr-5 fixed right-6 bottom-3 z-50 transition duration-800 ease-in-out ${showDialog? "bg-[#e07b00]":"bg-[#1ea61e]"}`}>
          ...
          <div
            ...
            <svg
              className="w-8 h-8 text-[#111811] transition-transform duration-300 ease-in-out hover:scale-125"
